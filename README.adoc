...
IMPORTANT: This booster requires Java 8 JDK or greater and Maven
...
To run this booster on your 

[source,bash,options="nowrap",subs="attributes+"]
----
$ git clone git@github.com:piyush1594/test-sync-pr-1
